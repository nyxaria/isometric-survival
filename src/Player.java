...
public class Player extends Entity {
	...
	public void updateImage() {
		if (Main.isKeyDown(KeyEvent.VK_W) && !Main.isKeyDown(KeyEvent.VK_S)) {
			...
			if (lastReleasedDir == 0 || lastReleasedDir == 4 || lastReleasedDir == 2 || lastReleasedDir == 6) {
				image = Canvas.tiler.get(set+"_" + lastReleasedDir + "_0");
			} else if(lastReleasedDir == 5){
				image = Canvas.tiler.get(set+"_" + lastReleasedDir + "_0");
			} else if(lastReleasedDir == 3){
				image = Canvas.tiler.get(set+"_" + lastReleasedDir + "_0");
			} else if(lastReleasedDir == 7){
				image = Canvas.tiler.get(set+"_" + lastReleasedDir + "_0");
			} else if(lastReleasedDir == 1){
				image = Canvas.tiler.get(set+"_" + lastReleasedDir + "_0");
			}
			return;
		}
